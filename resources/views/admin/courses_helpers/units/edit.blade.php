...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Lesson {{$unit->name}}</li>
        </ol>
    </section>
    <section class="content">
        ...
        <div class="row">
                <div class="col-md-12">
                        <a href="{{url('/admin/courses_helpers/'.$id.'/units')}}" class="btn btn-primary btn-lg" >back </a>
                </div>
        </div>
        <div class="row">
            <div class="col-md-offset-2 col-md-9">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('/admin/courses_helpers/'.$id.'/units/'.$unit->id)}}" method="POST">
                        @csrf
