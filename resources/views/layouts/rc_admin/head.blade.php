<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('AdminTheme/plugins/iCheck/flat/blue.css')}}">
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ asset('AdminTheme/plugins/morris/morris.css')}}">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ asset('AdminTheme/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ asset('AdminTheme/plugins/datepicker/datepicker3.css')}}">
    <!-- Daterange picker -->
