                          ...
                          <div class="courses__wapper">
                            <div class="col-equal courses__top">
                              <div class="courses__top__wapper">
                                <img class="courses__top__image" src="{{asset('educef/assets/img/courses-image/1.jpg')}}" alt="">
                              </div>
                              ...
                              <div class="courses__hover">
                                ...
                                <span class="courses__hover-content__item  course_likes " idCourse="{{$coure->id}}">
                                  <span class="glyph-icon flaticon-shapes courses__hover-content__icon">
                                  </span>
                                  </span>
                                  <span class="courses__hover-content__item">
                                  <span class="glyph-icon flaticon-interface courses__hover-content__icon course_likes">
                                  </span>
                                  </span>
                                  </div>
                              </div>
                            ...
                            <div class="col-equal courses__content">
                              ...
                              <span class="courses__content__author-name">T . {{$coure->teacher->name}}</span>
                              </a>
                              ...
                              <div class="courses__content__info">
                                <div class="courses__col-left">
                                  ...
                                  <span class="courses__content__number">{{$coure->likes->count()}}</span>
                                  </div>
